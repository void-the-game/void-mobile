...
export const spacing = {
  ...
  m_smd: { margin: base.smd },
  mt_smd: { marginTop: base.smd },
  mb_smd: { marginBottom: base.smd },
  ml_smd: { marginLeft: base.smd },
  mr_smd: { marginRight: base.smd },
  mx_smd: { marginHorizontal: base.smd },
  my_smd: { marginVertical: base.smd },
  p_smd: { padding: base.smd },
  pt_smd: { paddingTop: base.smd },
  pb_smd: { paddingBottom: base.smd },
  pl_smd: { paddingLeft: base.smd },
  pr_smd: { paddingRight: base.smd },
  px_smd: { paddingHorizontal: base.smd },
  py_smd: { paddingVertical: base.smd },
