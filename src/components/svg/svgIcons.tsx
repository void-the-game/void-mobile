...
import Svg, { Circle, Path, Rect, Line, Ellipse, Text as SvgText } from 'react-native-svg';
...
export const ArmadilhaIcon = () => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        <Rect x="20" y="15" width="40" height="55" rx="4" fill="#FFFFFF" stroke="#D1D5DB" strokeWidth="2" />
        <Rect x="25" y="20" width="30" height="8" fill="#F59E0B" opacity="0.3" />
        <Path d="M 28 50 L 32 45 L 48 45 L 52 50 Z" fill="#4B5563" stroke="#1F2937" strokeWidth="1.5" />
        <Path d="M 32 45 L 34 40 L 36 45" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Path d="M 37 45 L 39 40 L 41 45" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Path d="M 42 45 L 44 40 L 46 45" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Path d="M 28 38 L 32 43 L 48 43 L 52 38 Z" fill="#4B5563" stroke="#1F2937" strokeWidth="1.5" />
        <Path d="M 32 43 L 34 48 L 36 43" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Path d="M 37 43 L 39 48 L 41 43" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Path d="M 42 43 L 44 48 L 46 43" fill="#6B7280" stroke="#1F2937" strokeWidth="1" />
        <Circle cx="40" cy="44" r="3" fill="#F59E0B" stroke="#D97706" strokeWidth="1.5" />
        <Circle cx="40" cy="40" r="22" fill="rgba(245, 158, 11, 0.75)" />
        <Path d="M 40 30 L 43 42 L 37 42 Z" fill="#FFFFFF" stroke="#FFFFFF" strokeWidth="2" strokeLinejoin="round" />
        <Circle cx="40" cy="47" r="2" fill="#FFFFFF" />
        <Circle cx="40" cy="40" r="22" fill="none" stroke="#FFFFFF" strokeWidth="3" />
    </Svg>
);
...
export const BloqueiaRouboIcon = () => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <Path d="M 30 37 L 37 38" stroke="#becde1ff" strokeWidth="2" strokeLinecap="round" />
        <Path d="M 50 37 L 43 38" stroke="#becde1ff" strokeWidth="2" strokeLinecap="round" />
        <Path d="M 33 48 Q 40 52 47 48" stroke="#becde1ff" strokeWidth="2.5" fill="none" strokeLinecap="round" />
        ...
        <Line x1="25" y1="25" x2="55" y2="55" stroke="#FFFFFF" strokeWidth="4" strokeLinecap="round" />
        <Circle cx="40" cy="40" r="22" fill="none" stroke="#FFFFFF" strokeWidth="3" />
    </Svg>
);
...
export const BloqueiaCompraIcon = () => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <Path d="M 40 30 L 40 50 M 30 40 L 50 40" stroke="#000000ff" strokeWidth="6" strokeLinecap="round" opacity="0.5" />
        <Circle cx="40" cy="40" r="22" fill="rgba(239, 68, 68, 0.75)" />
        <Line x1="25" y1="25" x2="55" y2="55" stroke="#FFFFFF" strokeWidth="4" strokeLinecap="round" />
        <Circle cx="40" cy="40" r="22" fill="none" stroke="#FFFFFF" strokeWidth="3" />
    </Svg>
...
export const RefletirIcon = () => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        <Rect x="20" y="10" width="40" height="30" rx="4" fill="#FFFFFF" stroke="#D1D5DB" strokeWidth="2" />
        ...
        <Line x1="15" y1="43" x2="65" y2="43" stroke="#FFFFFF" strokeWidth="1.5" opacity="0.8" />
        <Rect x="20" y="46" width="40" height="30" rx="4" fill="#FFFFFF" stroke="#D1D5DB" strokeWidth="2" opacity="0.6" />
        ...
        <Line x1="35" y1="42" x2="38" y2="44" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
        <Line x1="45" y1="42" x2="42" y2="44" stroke="#ffffffff" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
    </Svg>
);
...
export const ComprarIcon = ({ color }: { color: string }) => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        <Rect x="15" y="25" width="35" height="45" rx="3" fill={color} opacity="0.8" />
        <SvgText x="32.5" y="52" fontSize="18" fill="#ffffffff" fontWeight="bold" textAnchor="middle">+1</SvgText>
        <Rect x="30" y="20" width="35" height="45" rx="3" fill={color} />
        <SvgText x="47.5" y="47" fontSize="18" fill="#ffffffff" fontWeight="bold" textAnchor="middle">+2</SvgText>
    </Svg>
);
...
export const BuracoNegroIcon = ({ color }: { color: string }) => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <Circle cx="40" cy="40" r="16" fill="none" stroke="#FFFFFF" strokeWidth="2.5" opacity="0.8" />
        <Circle cx="40" cy="40" r="22" fill="none" stroke="#FFFFFF" strokeWidth="2" opacity="0.5" />
        ...
        <Path d="M 22 40 Q 30 37 40 40" stroke="#FFFFFF" strokeWidth="1.8" fill="none" opacity="0.4" />
        <Path d="M 58 40 Q 50 43 40 40" stroke="#FFFFFF" strokeWidth="1.8" fill="none" opacity="0.4" />
    </Svg>
);
...
export const VorticeIcon = ({ color }: { color: string }) => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <Circle cx="40" cy="40" r="15" fill="none" stroke={color} strokeWidth="2" opacity="0.6" />
        <Circle cx="40" cy="40" r="10" fill="none" stroke={color} strokeWidth="2" opacity="0.3" />
        <Circle cx="40" cy="40" r="5" fill="none" stroke={color} strokeWidth="2" opacity="0.3" />
    </Svg>
);
...
export const ReciclarIcon = ({ color }: { color: string }) => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        ...
        <Circle cx="42.5" cy="40" r="14" fill="none" stroke="#000000" strokeWidth="2.5" />
        <SvgText x="42.5" y="41" fontSize="16" fill="#000000" fontWeight="bold" textAnchor="middle">→</SvgText>
        <SvgText x="42.5" y="52" fontSize="16" fill="#000000" fontWeight="bold" textAnchor="middle">←</SvgText>
    </Svg>
);
...
export const EstrelaDicasIcon = () => (
    <Svg width="80" height="80" viewBox="0 0 80 80">
        <Path d="M 40 10 L 50 35 L 75 35 L 55 50 L 65 75 L 40 60 L 15 75 L 25 50 L 5 35 L 30 35 Z" fill="#FBBF24" />
    </Svg>
);
...
export const AstronautIcon = ({ color = '#E91E63', size = 80 }: { color?: string; size?: number }) => (
    <Svg width={size} height={size} viewBox="0 0 100 100">
        {/* Braço esquerdo - mais fino embaixo */}
        <Path
        ...
        {/* Braço direito - mais fino embaixo */}
        <Path
        ...
        {/* Corpo/Tronco - bem mais arredondado */}
        <Path
        ...
        <Rect
            ...
            strokeWidth="2.5"
        />
        {/* Detalhes do painel - 3 pontinhos */}
