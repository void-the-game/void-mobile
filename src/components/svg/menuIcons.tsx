...
export function MissionsIcon({ color = '#F59E0B', size = 48 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" fill="none">
      {/* Corpo do foguete */}
      <Path
        d="M24 6 C24 6 32 14 32 26 L24 30 L16 26 C16 14 24 6 24 6Z"
        stroke={color}
        strokeWidth="2"
        strokeLinejoin="round"
        fill={color}
      ...
      {/* Chamas */}
      <Path
        d="M20 31 Q22 38 24 42 Q26 38 28 31"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        fill={color}
